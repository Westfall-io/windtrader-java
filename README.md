...
This project is **Project 1** in a larger pipeline:

1. **windtrader-java** (this repo): Java validator CLI (Xtext-based)
2. **windtrader**: Python wrapper that shells out to this JAR (multi-version support)
3. **sysml2py**: autogenerated Python builder library that produces SysML v2 text and validates via (1)
4. A higher-level Python tool that generates domain libraries (e.g., cloud instance models)
